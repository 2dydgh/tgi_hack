...
export class GameScene extends Phaser.Scene {
    ...
    // console.log(this.player.y);
      if(this.player.y<2300&&this.iscreated2==false){
        ...
        button1.addEventListener('click', () => { //짧게 선택시
            ...
            setTimeout(()=>{
                ...
                const element3 = this.add.dom(this.player.x, this.player.y)
                .createFromCache('q3');

                const button1 = document.createElement('button');
                button1.innerText = '액션,스포츠,어드벤쳐';
                button1.style.width = '100px';
                button1.style.height = '50px';
                button1.style.fontSize = '18px';
      ...
      if(this.player.y<3600 && this.iscreated==false){ //첫번째 질문 구현
